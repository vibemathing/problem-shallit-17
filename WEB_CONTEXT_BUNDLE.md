...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "shallit-17",
      "Shallit BC4 Open Problem 17: Fact(L*) universality complexity"
    ],
    "allowed_axioms": [
      "none"
    ],
    ...
    "statement": {
      "language": "en",
      "text": "Draft bounty intake target(s): Shallit BC4 Open Problem 17: Fact(L*) universality complexity. The exact mathematical statement, quantifiers, definitions, assumptions, and acceptance conditions have not yet been frozen; this draft is not research-admitted.",
      "version": 1
    },
    "title": "Shallit BC4 Open Problem 17: Fact(L*) universality complexity",
    "updated_at": "2026-09-08T08:24:29Z"
  },
  "problem_contract_sha256": "fdc94a98fe6ee513744d94a63aa69776e148d847a5cec3e04db5bebee0de159a"
}
```
